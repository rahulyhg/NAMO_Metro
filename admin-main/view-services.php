...
if($_REQUEST['act'] == "del")
	{	
		$query="delete from services where sub_id  =".$_REQUEST['did'];
...
/* Setup vars for query. */
	$targetpage = "view-services.php"; 	//your file name  (the name of this file)
...
$sql = "select * from services order by sub_date ASC LIMIT $start, $limit";
...
while($rowLogo = mysql_fetch_array($result))
	{
		...
		$dataLogo .= '
				<tr>
					...
					<td align="center">
						<a href="edit-services.php?did='.$rowLogo['sub_id'].'"><img src="images/icon-edit.jpg" alt="Edit" width="20" height="20" /> </a> 
						<a href="view-services.php?did='.$rowLogo['sub_id'].'&act=del" class="headerLink" onclick="return ask_ques();"><img src="images/icon-delete.jpg" alt="Delete" width="20" height="20" /></a>
					</td>
				</tr>
		';
	}
...
if($_REQUEST['msg']=='edit')
	{
		$msg="Services Edited successfully";
	}


    include("html/admin/header.html");
	include("html/admin/view-services.html");
