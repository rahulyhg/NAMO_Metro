...
// Get page data
$sql = "select * from registration where registration_status = 2 order by registration_date DESC LIMIT $start, $limit";
    ...
    <div class="modal-content">
      ...
      <?php 
        ...
        <label class='control-label'>Message</label>
            <textarea type='text'  name='reg_deact_msg' class='form-control' value=''></textarea>
            
            <div class='row'>
            	<div class='col-sm-2 col-sm-offset-4'>
            		<button type='button' class='btn btn-danger' data-dismiss='modal' style='width:200px; text-align:center'>Close</button>
            	</div>
        	</div>
        </form>";?>
      </div>
		...
		$dataLogo .= '
				<tr class="allqual '.$qunew.'">
					...
					<td align="center">
						...
						<a data-toggle="modal" class="myModal123" data-id="'.$rowLogo['registration_deactivation_msg'].'" style="color:green; cursor:pointer;">Reason</a>
					</td>
				</tr>
		';
	}
...
// print_r($result);exit;
	...
	include("html/admin/deactive-member.html");
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(".myModal123").click(function(){
    	...
    	$("textarea[name='reg_deact_msg']").val(id);
    	$('#myModal1').modal('show');
    });
  });
 </script>