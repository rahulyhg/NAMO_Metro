...
$sql = "SELECT registration_id,registration_email,registration_fname,registration_lname,registration_contact_address,registration_std,registration_telephone,registration_mobile1,registration_mobile2,registration_date FROM registration order by registration_date ASC";
