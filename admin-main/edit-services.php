...
if($_POST)
{
	if($_FILES['image_upload_above']['name'] == "")
		{
			$selectData = "select * from services where sub_id ='".$_REQUEST['did']."'";
	...
	else
		{
			...
			$file_path1="../services/".$file_name11;
			...
			redirect("view-services.php?msg=edit");
}
...
$oFCKeditor->Value		= stripslashes($rowData['sub_desc1']) ;
	...
	include("html/admin/edit-services.html");
