...
if($_REQUEST['act'] == "del")
	{	
		$query="delete from investor where sub_id  =".$_REQUEST['did'];
		$row = mysql_query($query) or die(mysql_error());
		redirect("view-data.php?msg=delete");
	}

$query = "SELECT COUNT(*) as num from investor";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];

/* Setup vars for query. */
	$targetpage = "view-investor.php"; 	//your file name  (the name of this file)
...
$sql = "select * from investor order by sub_date ASC LIMIT $start, $limit";
...
while($rowLogo = mysql_fetch_array($result))
	{
		...
		$dataLogo .= '
				<tr>
					...
					<td align="center">
						<a href="edit-investor.php?did='.$rowLogo['sub_id'].'"><img src="images/icon-edit.jpg" alt="Edit" width="20" height="20" /> </a> 
						<a href="view-investor.php?did='.$rowLogo['sub_id'].'&act=del" class="headerLink" onclick="return ask_ques();"><img src="images/icon-delete.jpg" alt="Delete" width="20" height="20" /></a>
					</td>
				</tr>
		';
	}
...
if($_REQUEST['msg']=='edit')
	{
		$msg="investor Edited successfully";
	}


    include("html/admin/header.html");
	include("html/admin/view-investor.html");
