...
if($_REQUEST['act'] == "del")
	{	
		$query="delete from projects_up where sub_id  =".$_REQUEST['did'];
		$row = mysql_query($query) or die(mysql_error());
		redirect("view-up-melawa.php?msg=delete");
	}

$query = "SELECT COUNT(*) as num from projects_up";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];

/* Setup vars for query. */
	$targetpage = "view-up-melawa.php"; 	//your file name  (the name of this file)
...
$sql = "select * from projects_up order by sub_date ASC LIMIT $start, $limit";
...
while($rowLogo = mysql_fetch_array($result))
	{
		...
		$dataLogo .= '
				<tr>
					...
					<td align="center">
						<a href="view-up-melawa.php?did='.$rowLogo['sub_id'].'&act=del" class="headerLink" onclick="return ask_ques();"><img src="images/icon-delete.jpg" alt="Delete" width="20" height="20" /></a>
...
if($_REQUEST['msg']=='edit')
	...
	include("html/admin/view-up-melawa.html");
