...
if($_POST)
{
	if($_FILES['image_upload_above']['name'] == "")
		{
			$selectData = "select * from investor where sub_id ='".$_REQUEST['did']."'";
	...
	else
		{
			...
			redirect("view-investor.php?msg=edit");
}
...
$oFCKeditor->Value		= stripslashes($rowData['sub_desc1']) ;
	...
	include("html/admin/edit-investor.html");
