...
if($_REQUEST['act'] == "del")
	{	
		$query="delete from orders where order_id   =".$_REQUEST['did'];
		$row = mysql_query($query) or die(mysql_error());
		redirect("view-completed.php?msg=delete");
	}	


$query = "SELECT COUNT(*) as num from orders where order_status = 1";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];

/* Setup vars for query. */
	$targetpage = "view-completed.php"; 	//your file name  (the name of this file)
...
$sql = "select * from orders where order_status = 1  order by order_date asc LIMIT $start, $limit";
...
while($rowLogo = mysql_fetch_array($result))
	...
	include("html/admin/view-completed.html");
