		...
		<div style="background:#d9d9d9; padding:30px;height:auto; text-align:justify;" >
	       ...
	       <br/>
			...
			<div class="col-sm-10 col-sm-offset-1">
				<li>Use https://www.saiprasadvivah.net for uploading  website.</li>
				<li>For best performance and mobile View please use updated browser.</li>
				<li>Complete your Profile 100% as per indicator shown on your screen. Please check your Birth date, birth time, contact Address, etc...you can Edit</li>
				<li>Please add your 2 or 3 new photos in MY ALBUM</li>
				<li>Please upload your Profile Photo (as soon as possible)</li>
				<li>In Basic Details Update your PAN card or Aadhar card no.(as soon as possible) 
OR send scan any one copy of ID Proof like Pan card, Aadhar card,Passport,Election card,etc..by E mail saiprasadvivah@gmail.com  with your full name</li>
				<li>Please Check your profile daily on our Website & take a facility of Send Messages.</li>
				<li>If your ENGAGEMENT OR MARRIAGE is fixed, for delete or Remove your profile from our Web Site. Telephonic communication will not be treated as an official Massage. Only Official E-Mail is Compulsory.</li>
			</div>
			</div>
			<br/>
	       <br/>
