...
$query = "SELECT COUNT(*) as num from usertosurvey";
...
$sql = "select * from usertosurvey order by date DESC LIMIT $start, $limit";
...
//////////////////////////////////////////////////////////////////	
		...
		$dataLogo .= '
				<tr>
					...
					<td><a href="view-udetail.php?cmpn='.$rowCompanyName['company'].'">'.ucfirst($rowCompanyName['company']).'</a></td>
					<td>'.ucfirst($rowCompanyName['refname']).'</td>
					<td><a href="view-detail.php?pid='.$rowPresentation['videoId'].'">'.$rowPresentation['video_name'].'</a></td>
					<td>'.$dateANDtime.'</td>
					<td align="center">
						'.$statusLogo.' 
						<a href="show-user-present.php?act=del&lid='.$rowLogo['id'].'" class="headerLink" onclick="return ask_ques();"><img src="images/icon-delete.jpg" alt="Delete" width="20" height="20" /></a>
					</td>
				</tr>
		';
	}
...
if($_REQUEST['msg']=='padd')
	...
	include("html/admin/show-user-present.html");
