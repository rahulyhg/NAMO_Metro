...
<!-- banner -->
	<div class=""><!--class="banner"-->
		<div class="container-fluid">
        	<div class="col-md-12">
            	<p> <marquee direction="left"><!-- Welcome to SHREE SAI PRASAD VIVAH Founder President Mr.Baburao Sonawane, Matrimonial Trusted by Millions of Hindu-Chambhar across the World, Most visited Matrimonial Site. --><?php echo $news[0]['content'] ?></marquee></p>
            </div>
		...
		<div class="container">
			...
			<div class="testimonials-grids">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12 col-lg-6 testimonials-grid-right">
					...
					<input type="text" class="download-app"   name="mailid" placeholder="Enter your Mobile No." style="cursor:not-allowed;" required>
