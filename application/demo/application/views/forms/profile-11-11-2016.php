    ...
    <div class="col-md-9 profile">
      <div class="comments">
        <div class="comments-grid">
          <div class="comments-grid-left"> <img src="<?php echo base_url().'register/'.$data[0]['registration_photo']?>" alt=" "/> </div>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <!-- <td colspan="3">
                          <a href="<?php echo base_url('common/edit_profile');?>"><button class="btn btn-danger pull-right" type="submit">Edit</button></a>
                          </td> -->
                      </tr>
                      <tr>
                  ...
                  <table>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td colspan="3"> </td>
                        <td colspan="3">
                         <a href="<?php echo base_url('common/edit_profile');?>"><button class="btn btn-danger pull-right" type="submit">Edit</button></a>                          </td>
                      </tr>
                      <!-- <tr>
                      <td><strong>Children</strong></td>
                      <td colspan="2"><select id="TxtChildren" name="TxtChildren" class="form-control">
                  ...
                  <table>
                    <tbody>
                      <tr>
                        ...
                        <td colspan="4"><?php echo $data[0]['registration_horoscope']?></td>
                      </tr>
                      <tr>
