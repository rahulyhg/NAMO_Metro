    ...
    <div class="col-md-9 single-left">
     <div class="alert_msg3"></div>
       <div class="accordion">
            <dl>
              <dt>
                <a href="#accordion1" aria-expanded="false" aria-controls="accordion1" class="accordionTitleActive accordionTitle js-accordionTrigger ">Basic Detail </a> 
                
              </dt>
              <dd class="accordion-content <?php if($active == 101){ echo "is-expanded"; }else { echo "is-collapsed";} ?> accordionItem " id="accordion1" aria-hidden="true">
...
<!--                           <option value="Hindu" selected="selected">Hindu</option>
 -->                        </select></td>
            ...
            <?php endif; ?>                         
              ...
              <dd class="accordion-content accordionItem <?php if($active == 102){ echo "is-expanded"; }else { echo "is-collapsed";} ?>" id="accordion2" aria-hidden="true">
              ...
              <dd class="accordion-content accordionItem <?php if($active == 103){ echo "is-expanded"; }else { echo "is-collapsed";} ?>" id="accordion3" aria-hidden="true">
              ...
              <dd class="accordion-content accordionItem <?php if($active == 104){ echo "is-expanded"; }else { echo "is-collapsed";} ?>" id="accordion3" aria-hidden="true">
              ...
              <dd class="accordion-content accordionItem <?php if($active == 105){ echo "is-expanded"; }else { echo "is-collapsed";} ?>" id="accordion3" aria-hidden="true">
              ...
              <dd class="accordion-content accordionItem <?php if($active == 106){ echo "is-expanded"; }else { echo "is-collapsed";} ?>" id="accordion3" aria-hidden="true">
              ...
              <dd class="accordion-content accordionItem <?php if($active == 107){ echo "is-expanded"; }else { echo "is-collapsed";} ?>" id="accordion3" aria-hidden="true">
             ...
             <option value="Athletic" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_bodytype']) == 'Athletic')?'selected':''?>>Athletic</option>
                    ...
                    <tr>
                      ...
                      <td colspan="2"><select name="partner_educationlevel" id="TxtPartnerEducationLevel" class="form-control">
                       <?php
                         if((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == (empty($partner_data)?"":$partner_data[0]['partner_educationlevel'])):
                        ?>
                        ...
                        <option value="Not Specified" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == 'Not Specified')?'selected':''?>>Select</option>
                         <option value="Any" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == 'Any')?'selected':''?>>Any</option>
                         <option value="Bachelors" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == 'Bachelors')?'selected':''?>>Bachelors</option>
                          <option value="Masters" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == 'Masters')?'selected':''?>>Masters</option>
                  <option value="Doctorate" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == 'Doctorate')?'selected':''?>>Doctorate</option>
                <option value="Diploma" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == 'Diploma')?'selected':''?>>Diploma</option>
                   <option value="Undergraduate" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == 'Undergraduate')?'selected':''?>>Undergraduate</option>
               <option value="Associate Degree" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == 'Associate Degree')?'selected':''?>>Associate Degree</option>
                   <option value="Hounors Degree" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == 'Hounors Degree')?'selected':''?>>Hounors Degree</option>
                   <option value="Trade School" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == 'Trade School')?'selected':''?>>Trade School</option>
                   <option value="High School" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == 'High School')?'selected':''?>>High School</option>
                    <option value="Less than 10" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == 'Less than 10')?'selected':''?>>Less than 10</option>
                  <option value="Less than 12" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_educationlevel']) == 'Less than 12')?'selected':''?>>Less than 12</option>
                <?php endif; ?>
                </select></td>
                         <td><strong>Employed Level</strong></td>
                      <td colspan="2"><select id="Partneremployedin" name="partner_employedlevel" class="form-control">
                      <?php
                         if((empty($partner_data)?"":$partner_data[0]['partner_employedlevel']) == (empty($partner_data)?"":$partner_data[0]['partner_employedlevel'])):
                        ?>
                        ...
                        <option value="Not Specified" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_employedlevel']) == 'Not Specified')?'selected':''?>>Select</option>
                         <option value="Any" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_employedlevel']) == 'Any')?'selected':''?>>Any</option>
                  <option value="Service" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_employedlevel']) == 'Service')?'selected':''?>>Service</option>
               <option value="Government" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_employedlevel']) == 'Government')?'selected':''?>>Government</option>
                <option value="Private" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_employedlevel']) == 'Private')?'selected':''?>>Private</option>
                <option value="Business" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_employedlevel']) == 'Business')?'selected':''?>>Business</option>
                 <option value="Defence" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_employedlevel']) == 'Defence')?'selected':''?>>Defence</option>
               <option value="Self Employed" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_employedlevel']) == 'Self Employed')?'selected':''?>>Self Employed</option>
                 <option value="Not Required" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_employedlevel']) == 'Not Required')?'selected':''?>>Not Required</option>
               <?php endif; ?>
                </select></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                     ...
                     <?php
                         if((empty($partner_data)?"":$partner_data[0]['partner_subgroup']) == (empty($partner_data)?"":$partner_data[0]['partner_subgroup'])):
                        ?>
                      <option value="Not Specified" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_subgroup']) == 'Not Specified')?'selected':''?>>Select</option>
                       <option value="Any" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_subgroup']) == 'Any')?'selected':''?>>Any</option>
                      <option value="Deshastha" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_subgroup']) == 'Deshastha')?'selected':''?>>Deshastha</option>
                      <option value="Kokanastha" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_subgroup']) == 'Kokanastha')?'selected':''?>>Kokanastha</option>
                    <?php endif; ?>
                      </select></td>
                         <td><strong>City </strong></td>
                      <td colspan="2"><select id="PartnerCity" name="partner_city" class="form-control">
                    <?php
                         if((empty($partner_data)?"":$partner_data[0]['partner_city']) == (empty($partner_data)?"":$partner_data[0]['partner_city'])):
                        ?>
              <option value="Not Specified" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Not Specified')?'selected':''?>>Select</option>
               <option value="Any" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Any')?'selected':''?>>Any</option>
               <option value="Mumbai" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Mumbai')?'selected':''?>>Mumbai</option>
                <option value="Pune" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Pune')?'selected':''?>>Pune</option>
                 <option value="Thane" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Thane')?'selected':''?>>Thane</option>
                 <option value="Navi Mumbai" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Navi Mumbai')?'selected':''?>>Navi Mumbai</option>
                   <option value="Satara" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Satara')?'selected':''?>>Satara</option>
                <option value="Nashik" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Nashik')?'selected':''?>>Nashik</option>
                 <option value="Aurangabad" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Aurangabad')?'selected':''?>>Aurangabad</option>
                <option value="Bangalore" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Bangalore')?'selected':''?>>Bangalore</option>
                <option value="Hyderabad" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Hyderabad')?'selected':''?>>Hyderabad</option>
                <option value="Delhi" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Delhi')?'selected':''?>>Delhi</option>
                 <option value="Chennai" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Chennai')?'selected':''?>>Chennai</option>
               <option value="Sindhudurg" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_city']) == 'Sindhudurg')?'selected':''?>>Sindhudurg</option>
...
<option value="Sangali">Sangali</option>
                <?php endif; ?>
                    ...
                    <tr>
                      ...
                      <td colspan="2"><select id="PartnerState" name="partner_state" class="form-control">
                       <?php
                         if((empty($partner_data)?"":$partner_data[0]['partner_state']) == (empty($partner_data)?"":$partner_data[0]['partner_state'])):
                        ?>
                       <option value="Not Specified" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_state']) == 'Not Specified')?'selected':''?>>Select</option>
                        <option value="Any" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_state']) == 'Any')?'selected':''?>>Any</option>
                        <option value="Maharashtra" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_state']) == 'Maharashtra')?'selected':''?>>Maharashtra</option>
                ...
                <?php endif; ?>
                      ...
                      <?php
                         if((empty($partner_data)?"":$partner_data[0]['partner_country']) == (empty($partner_data)?"":$partner_data[0]['partner_country'])):
                        ?>
                      ...
                      <option value="India" <?php echo ((empty($partner_data)?"":$partner_data[0]['partner_country']) == 'India')?'selected':''?>>India</option>
                <option value="United States of America">United States of America</option>
                <option value="United Arab Emirates">United Arab Emirates</option>
                <option value="Malaysia">Malaysia</option>
                <option value="United Kingdom">United Kingdom</option>
