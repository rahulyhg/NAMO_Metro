                ...
                <!--        You can switch "ct-wizard-orange"  with one of the next bright colors: "ct-wizard-blue", "ct-wizard-green", "ct-wizard-orange", "ct-wizard-red"             -->
                       ...
                       <h3> <a href="<?php echo base_url();?>"><img src="<?php echo base_url();?>public/images/logo-(1).png" class="img-responsive"></a></h3>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="col-sm-8 col-sm-offset-2" style="text-align: center"><p style="text-decoration: underline;" id="terms"><input type="checkbox" name="termsCondition" id="termsCondition"  style="height:19px; width:19px; margin-right: 1%;margin-top: 4%;"/>I have read and agree to the <b><a href="<?php echo base_url('common/privacy_policy');?>" target="_blank">Terms & Conditions.</a></b></p></div>
                        </div>
