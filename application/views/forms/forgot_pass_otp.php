		...
		<div class="login-form"> 
			...
			<div class="agileits-top">
					...
					<div class="styled-input">
						...
						<input type="text" name="registration_pass_otp" id="registration_pass_otp" required/>
						<label>OTP</label>
						<span></span>
					</div>
			</div>
			<div class="agileits-bottom">
					<input type="button" onclick="forgot_pass_otp_confirm();" value="Submit">
			</div>
			</form>
