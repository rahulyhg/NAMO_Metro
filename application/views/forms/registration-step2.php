<?php
  ...
  // print_r($data);exit;
$date = strtotime(''.date("d-m-Y").' -18 year');
                ...
                <div class="tab-pane" id="account">
                  <div class="row">
                    ...
                    <div class="col-sm-5 col-sm-offset-1">
                     ...
                     <div class="col-sm-5">
                      <div class="form-group">
                        <label>Birth Date<small>(required)&nbsp;&nbsp;(dd-mm-yyyy)</small></label>
                        <input name="registration_birth_date" id="registration_birth_date" type="text" class="form-control" value="<?php echo $date ?>" required>
                      </div>
                    </div>
                    <!-- <hr>--> 
