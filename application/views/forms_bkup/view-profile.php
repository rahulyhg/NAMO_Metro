...
<div class="single">
  ...
  <div class="container" style="margin-top:1%;">
    ...
    <?php if($data[0]['registration_photo_visibility'] == 0): ?>
          ...
          class="img-responsive thumbnail zoom"  style="width:125px; height:125px;"  />
    ...
    <div class="col-md-5 contact-details">
      <h4 style="color:#333;"><i class="glyphicon glyphicon-map-marker"></i>&nbsp;&nbsp;Contact Details</h4>
        <table style="width:100%;border:none;">
                    <tbody style="border:none;">
                    <col style="width:30%;" />
                    <col style="width:70%;" />
                      <tr style="border:none;">
                        <td style="color:#666; font-size:13px; padding:1px 4px; border:none;">Contact Address</strong></td>
                        <td style="color:#666; font-size:13px; padding:1px 4px; border:none;text-align:justify; text-transform:capitalize;"><?php echo $data[0]['registration_contact_address']?></td>
                      </tr>
                      
                       <tr style="border:none;">
                         <td style="color:#666; font-size:13px; padding:1px 4px;border:none;">Mobile No.</strong></td>
                        <td colspan="1" style="color:#999; padding:1px 4px;border:none;"><?php echo $data[0]['registration_mobile1']?></td>
                      </tr>
                       <tr style="border:none;">
                        <td style="color:#666; font-size:13px; padding:1px 4px;border:none;">Alternate Mobile No.</strong></td>
                        <td colspan="1" style="color:#999; padding:1px 4px;border:none;"><?php echo $data[0]['registration_mobile2']?></td>
                      </tr>
                      <tr style="border:none;">
                         <td style="color:#666; font-size:13px; padding:1px 4px;border:none;">Telephone No.</strong></td>
                        <td colspan="1" style="color:#999; padding:1px 4px;border:none;"><?php echo $data[0]['registration_telephone']?></td>
                      </tr>
        ...
        <div class="resp-tabs-container hor_1">
         ...
         <div class="demo-gallery">
            <ul id="lightgallery" class="list-unstyled row">
              <?php 
                  if(!empty($album) && $album[0]['album_photo_visibility'] == 0) :
              ...
              ?>
                <li class="col-xs-6 col-sm-8 col-sm-offset-4" >
                    
                      <span style="padding: 2%;">No image to Show</span>
