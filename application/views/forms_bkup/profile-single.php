  ...
  <div class="container">
    ...
    <tr>
      ...
      <td><?php echo $profile_data[0]['registration_height']?></td>
        ...
        <tr>
		  <td colspan="4"><a href="<?php echo base_url();?>common/profile_advance_search"><button name="search" class="btn btn-danger pull-left" >Back</button></a> 
           <a href="<?php echo base_url().'common/view_profile/'.$profile_data[0]['registration_id']?>""><button name="search" class="btn btn-danger pull-right" >View Full Profile</button></a></td>
  		</tr> 
		</tbody>
	</table>  
