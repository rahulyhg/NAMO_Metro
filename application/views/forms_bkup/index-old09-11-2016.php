...
<!-- banner -->
	<div class=" "><!--class="banner"-->
		<div class="container-fluid">
        	<div class="col-md-12">
            	<p> <marquee direction="left">Welcome to SHREE SAI PRASAD VIVAH Founder President Mr.Baburao Sonawane, Matrimonial Trusted by Millions of Hindu-Chambhar across the World, Most visited Matrimonial Site.</marquee></p>
            </div>
			...
			<div class="banner-left">
                ...
                <p>Launching Soon Mobile App </p></div>
				<img src="<?php echo base_url();?>public/images/google.png" class="img-responsive"> 
 			</div>
			...
			<div class="testimonials-grids">
				...
				<div class="col-md-6 testimonials-grid-right">
                    ...
                    <div class="col-sm-12" style="padding-top: 3%;">
                        <h4 class="text-center">Download Google App</h4>
                          <form action="<?php echo base_url() ?>common/newsletter_email" method="post">
					<input type="text" name="mailid" placeholder="Enter your Mobile No." required>
					<input type="submit" value="Send App Link">
				</form>
                <p class="pull-right"><img src="<?php echo base_url();?>public/images/google.png" alt="" />   </p>
                    </div>
                    <!--<div class="events-grid2">
                    	<div class="events-grid2-left">
			...
			<div class="events-grids">
				<div class="col-md-4 events-grid">
					<div class="events-grid1 hvr-sweep-to-top">
						<a href="#"><img src="<?php echo base_url();?>public/images/7.jpg" alt=" " class="img-responsive" /></a>
						<h4><a href="#">oribus asperiores</a></h4>
						<ul>
				...
				<div class="col-md-4 events-grid">
					<div class="events-grid1 hvr-sweep-to-top">
						<a href="#"><img src="<?php echo base_url();?>public/images/7.jpg" alt=" " class="img-responsive" /></a>
						<h4><a href="#">iusto odio dignissi</a></h4>
						<ul>
							<li><a href="#"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Admin</a></li>
				...
				<div class="col-md-4 events-grid">
					<div class="events-grid1 hvr-sweep-to-top">
						<a href="#"><img src="<?php echo base_url();?>public/images/7.jpg" alt=" " class="img-responsive" /></a>
						<h4><a href="#">tatum deleniti atque</a></h4>
						<ul>
							<li><a href="#"><span class="glyphicon glyphicon-user" aria-hidden="true"></span>Admin</a></li>
